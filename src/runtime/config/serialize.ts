...
// STOLEN FROM https://github.com/cloudflare/workers-sdk/blob/main/packages/miniflare/src/runtime/config/index.ts
...
export const generateConfigBinary = (config: Config): Buffer => {
